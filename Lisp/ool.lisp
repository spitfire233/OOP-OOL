...
;;; che � una lista di liste. Viene restituita una lista 
...
;;; is-superclass: restituisce nil se <type-f-part> � 
...
;;; hanno un tipo che � un sottotipo del campo corrispondente in
...
;;; � una classe valida, nil altrimenti.
...
;;; � 'methods, la lista conterr� solo i campi. Se la parola specificata
;;; � 'fields, la lista conterr� solo i metodi.
...
;;; struttura risulta corretta oppure se <field-name-value> � nullo.
...
;;; T se tutti i campi di <instance-fields> hanno un tipo che � un
...
;;; l'istanza di una classe. Se class-name e' T allora value pu�
...
;;; non � presente nell'istanza, la ricerca prosegue
;;; nella classe o nelle sue super-classi. Se il campo 
;;; non esiste nella classe dell'istanza (ossia, se non � ereditato),
